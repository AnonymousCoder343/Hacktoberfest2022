...
# TRAINING DATA
        ...
        lr = Button(screen, text="Predict",height=2, width=20, command=message,bg='#57a1f8',fg='red',relief="sunken")
...
user = Entry(frame,width = 25, fg ='black',border=0,bg="red",font =('Helvetica',11))
...
code = Entry(frame,width = 25, fg ='black',border=0,bg="red",font =('Microsoft YaHei UI Light',11))
code.place(x=30,y=150)
code.insert(0,'Password')
code.bind('<FocusIn>',on_enter)
code.bind('<FocusOut>',on_leave)
Frame(frame,width=295, height= 2,bg='black').place(x=25,y=177)
Button(frame,width=39,pady=7,text='Sign in',bg='#57a1f8',fg='grey',border=0,command=signin).place(x=35,y=204)
label = Label(frame, text="Don't have an account?",fg ='black',bg='blue',font=('Microsoft YaHei UI Light',9))
label.place(x=75,y=270)
sign_up  =Button(frame,width=6,text='Sign up',border=0,bg='green',cursor='hand2',fg='#57a1f8',command=signin)
